...
public abstract class UpdateMultipleFilesNonGenericAbstractTest extends
        net.sf.sevenzipjbinding.junit.compression.UpdateMultipleFilesAbstractTest<IOutItemAllFormats> {
    public class ArchiveUpdateCallback implements IOutCreateCallback<IOutItemAllFormats> {
        net.sf.sevenzipjbinding.junit.compression.UpdateAbstractTest.ArchiveUpdateCallbackGeneric delegate;
