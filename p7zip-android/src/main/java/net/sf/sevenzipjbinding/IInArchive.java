...
public interface IInArchive extends Closeable {
     ...
     *
     * @param index  index of item to get property value. 0 - first archive item.
     * @param propID property to get value of
     ...
     * directory.
     *
     * @param index  index of item in archive to get property of. 0 - first archive item.
     ...
     *
     * @param indices         (optional) array of indices of archive items to extract.<br>
     *                        <code>null</code> - all archive items.
     * @param testMode        <code>true</code> - test archive items only<br>
     *                        <code>false</code> - extract archive items
     * @param extractCallback extraction callback object. Optional implementation of {@link ICryptoGetTextPassword}.
     * @throws SevenZipException 7-Zip or 7-Zip-JBinding error occur. Use {@link SevenZipException#printStackTraceExtended()} to get
     *                           stack traces of this SevenZipException and of the all thrown 'cause by' exceptions.
     */
     ...
     *
     * @param index     index of the item to extract. 0 - first archive item.
     * @param outStream sequential output stream to get content of the item
