 ...
 *
 *  if (outArchive instanceof {@link IOutUpdateArchiveZstd}) {
 *    {@link IOutUpdateArchiveZstd} outUpdateArchiveGZip = ({@link IOutUpdateArchiveZstd})outArchive;
 *    ...
 *  }
 *
 ...
 * @since 9.20-2.00
 */
public interface IOutUpdateArchiveZstd extends IOutUpdateArchive<IOutItemZstd>, IOutFeatureSetLevel {
}
