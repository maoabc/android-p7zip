...
public interface IOutCreateArchiveZip extends IOutCreateArchive<IOutItemZip>, //
        IOutFeatureSetLevel, IOutFeatureSetMultithreading, IOutFeatureSetEncryptionMethod {
     ...
     * <br>
     *
     * @param outStream         output stream to get the new archive
     * @param numberOfItems     number of items in the new archive
     * @param outCreateCallback callback object to exchange information about archive create operation.
